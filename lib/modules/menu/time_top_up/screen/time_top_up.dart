...
import 'package:ebikesms/modules/menu/time_top_up/screen/time_top_up_validation.dart';
    ...
    _controller.addListener(() {
      ...
      setState(() {
        if (amount < PricingConstant.minTopUpAmt) {
          ...
          labelText =
              "Ride Time: ${Calculation.countRideTimeFormatted(int.parse(_controller.text))}";
          labelColor = ColorConstant.black;
          isValidAmount = true;
        }
      });
                  ...
                  child: RectangleButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  TimeTopUpValidation(keyedTotal: value)));
                    },
